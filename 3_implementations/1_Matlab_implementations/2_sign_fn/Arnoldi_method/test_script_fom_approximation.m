...
m = 310; % No. of iterations for the krylov's subspace

start = cputime;

%% Calucation of the approximation for f(A)b
% Call the FOM approximation function
fom_approximation = fom(A, b, m);

finish = cputime;
disp(['Time taken by FOM scheme = ', num2str(finish - start), ' s']);
