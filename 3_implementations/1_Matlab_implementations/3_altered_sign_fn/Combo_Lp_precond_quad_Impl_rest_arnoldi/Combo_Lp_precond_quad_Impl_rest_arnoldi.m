function [fA_b] = Combo_Lp_precond_quad_Impl_rest_arnoldi(A, b, k_values, m1, m2, max_iter, thick_num, tol, min_decay)
    ...
    for l=1:no_k  %l-th column holds approx. for subspace dimension k(l)
        [fA_b(:,l), ~, ~] = Quad_based_impl_rest_arnoldi(A, v, c_norm, theta, k_values(l), m1, m2, max_iter, thick_num, tol, min_decay);
    end
end